...
public class HatchingService {
    ...
    public void completeHatchProcess(final Map<String, String> responses) {
        try {
            ...
            final String teamName = responses.get("team_name");
            if (teamName != null && !teamName.trim().isEmpty()) {
                log.info("🏢 Configuring team workspace: {}", teamName);
            ...
            final AgentConfiguration.LLMProvider provider = agentConfiguration.getFallbackProvider();
